...
const styles = StyleSheet.create({
  ...
  greeting: { color: '#8E9BAE', fontSize: 11, fontFamily: 'DMSans-Medium', fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1.76 },
  title: { color: '#FFFFFF', fontSize: 26, fontFamily: 'PlayfairDisplay-Bold', fontWeight: '700', lineHeight: 29 },
  ...
  avatarText: { color: '#CCFF00', fontSize: 14, fontFamily: 'DMSans-Bold', fontWeight: '700' },
  ...
  livePillText: { color: '#CCFF00', fontSize: 10, fontFamily: 'DMSans-Bold', fontWeight: '700', letterSpacing: 1 },
  syncTitle: { color: '#FFFFFF', fontSize: 17, fontFamily: 'DMSans-Bold', fontWeight: '700', marginTop: 12 },
  syncSub: { color: '#8E9BAE', fontSize: 12, fontFamily: 'DMSans-Regular', marginTop: 4, marginBottom: 16 },
  syncBtn: { height: 46, backgroundColor: '#CCFF00', borderRadius: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 8 },
  syncBtnText: { color: '#000', fontSize: 14, fontFamily: 'DMSans-Bold', fontWeight: '700' },
  ...
  tagText: { color: '#8E9BAE', fontSize: 10, fontFamily: 'DMSans-Medium' },
  sectionRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingTop: 18, paddingBottom: 10 },
  sectionTitle: { color: '#FFFFFF', fontSize: 15, fontFamily: 'DMSans-Bold', fontWeight: '700' },
  seeAll: { color: '#CCFF00', fontSize: 12, fontFamily: 'DMSans-Bold', fontWeight: '600' },
  ...
  matchLeague: { color: '#8E9BAE', fontSize: 9, fontFamily: 'DMSans-Bold', fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1.26, marginBottom: 6 },
  matchTeams: { color: '#FFFFFF', fontSize: 12, fontFamily: 'DMSans-Bold', fontWeight: '700', lineHeight: 18 },
  matchDay: { color: '#8E9BAE', fontSize: 10, fontFamily: 'DMSans-Regular' },
  ...
  scoreText: { color: '#CCFF00', fontSize: 11, fontFamily: 'PlayfairDisplay-Bold', fontWeight: '700' },
  ...
  emptyText: { color: '#8E9BAE', textAlign: 'center', fontSize: 12, fontFamily: 'DMSans-Regular', lineHeight: 18 },
  ...
  statNum: { color: '#CCFF00', fontSize: 28, fontFamily: 'PlayfairDisplay-Bold', fontWeight: '900' },
  statLabel: { color: '#8E9BAE', fontSize: 10, fontFamily: 'DMSans-Medium', fontWeight: '500', textAlign: 'center', lineHeight: 14 },
  ...
  quickLabel: { color: '#FFFFFF', fontSize: 13, fontFamily: 'DMSans-Bold', fontWeight: '700' },
});
